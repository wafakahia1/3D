...
})({"hHjLx":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "bb08393a8cf34361";
"use strict";
...
},{}],"4Klkl":[function(require,module,exports) {
/* globals Stats, dat, AMI*/ // standard global letiables
var _studyService = require("./utils/StudyService");
let controls;
let threeD;
let renderer;
let stats;
...
let objList = [];
(0, _studyService.getSeriesObjPathBySeriesKy)(seriesId).then((obj)=>{
    obj.forEach((o)=>{
 ...
 */ function buildGUI() {
    ...
    stepsUpdate.onChange(function(value) {
        if (vrHelper.uniforms) vrHelper.uniforms.uSteps.value = value;
    });
    ...
    alphaCorrrectionUpdate.onChange(function(value) {
        if (vrHelper.uniforms) vrHelper.uniforms.uAlphaCorrection.value = value;
    });
...
;
var _c;
$RefreshReg$(_c, "Render3D");

},{"./utils/StudyService":"6DafC"}],"6DafC":[function(require,module,exports) {
/*Get Study by id*/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getSeriesByStudyKy", ()=>getSeriesByStudyKy);
parcelHelpers.export(exports, "getSeriesObjPathBySeriesKy", ()=>getSeriesObjPathBySeriesKy);
var _axiosUtils = require("./axios-utils");
var _axiosUtilsDefault = parcelHelpers.interopDefault(_axiosUtils);
const getSeriesByStudyKy = (id)=>{
    return new Promise((resolve, reject)=>{
        (0, _axiosUtilsDefault.default)({
...
const getSeriesObjPathBySeriesKy = (id)=>{
    return new Promise((resolve, reject)=>{
        (0, _axiosUtilsDefault.default)({
...
},{"./axios-utils":"27uR5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"27uR5":[function(require,module,exports) {
...
const Interceptor = (0, _axiosDefault.default).create({
...
Interceptor.interceptors.response.use((response)=>{
    ...
    if (!error.response) {
        ...
        return Promise.reject("Network Error");
    } else if (error.response.status === 403 && !originalRequest._retry) console.log("Your token has expired");
    else {
        setTimeout(()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hHjLx","1xC6H","4Klkl"], "4Klkl", "parcelRequire047a")

//# sourceMappingURL=index.8cf34361.js.map
